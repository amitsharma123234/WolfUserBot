...
# set blacklist_chats where you do not want wolfuserbot's features
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "WolfUserBot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/4dcf1dd4247fbd492ecf3.jpg"    
...
if STRING_SESSION:
    ...
    # pylint: disable=invalid-name
    bot = TelegramClient("wolfuserbot", API_KEY, API_HASH)
...
async def check_botlog_chatid():
    if not BOTLOG_CHATID and LOGSPAMMER:
        ...
        LOGS.info(
            "You must set up the BOTLOG_CHATID variable in the config.env or environment variables, for the wolfuserbot logging feature to work."
        )
        quit(1)
...
with bot:
    try:
        ...
        LOGS.info(
            ...
            "Please generate proper group id and set.You can ask in @Wolf_User_Bot if you need help")
        quit(1)
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
                                "https://github.com/WolfGangIndia/WolfUserBot"),
                            custom.Button.url(
                                "Support",
                                "https://t.me/Wolf_User_Bot")],
                    ],
                    link_preview=False,
                )
