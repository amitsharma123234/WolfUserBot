...
""" WolfUserBot module for other small commands. """
...
import io
import sys
from wolfuserbot import BOTLOG, BOTLOG_CHATID, CMD_HELP, bot, GIT_REPO_NAME, ALIVE_NAME
from wolfuserbot.events import register
from wolfuserbot.utils import time_formatter
import urllib
import requests
...
async def sleepybot(time):
    """ For .sleep command, let the wolfuserbot snooze for a few second. """
...
async def bot_community(community):
    ...
    await community.edit(
        "Join WolfGang's awesome wolfuserbot community: @Wolf_User_Bot"
...
async def bot_support(wannahelp):
    ...
    await wannahelp.edit(
        "Join WolfUserBot Channel: @RkProjects \
        \nJoin WolfUserBot Chat: @Wolf_User_Bot")


@register(outgoing=True, pattern="^.creator$")
async def creator(e):
    await e.edit("[Rajveer](https://t.me/Smart_S54)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[WolfUserBot's README.md file](https://github.com/WolfGangIndia/WolfUserBot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [here](https://github.com/WolfGangIndia/WolfUserBot) to open WolfGang's GitHub page."
    )
...
async def raw(event):
    ...
    with io.BytesIO(str.encode(the_real_message)) as out_file:
        ...
        await event.edit(
            "`Check the wolfuserbot log for the decoded message data !!`")
...
\n\n`.repo`\
\nUsage: If you are curious what makes the wolfuserbot work, this is what you need !!\
\n\n`.myrepo`\
\nUsage: If you are curious which is your personal repo, this is what you have.\
\n\n`.readme`\
\nUsage: Provide links to setup the wolfuserbot and it's modules.\
\n\n`.creator`\
\nUsage: Know who created this awesome wolfuserbot !!\
\n\n`.repeat` <no.> <text>\
