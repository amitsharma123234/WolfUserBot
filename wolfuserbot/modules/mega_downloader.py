...
from wolfuserbot import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
from wolfuserbot.events import register
from wolfuserbot.utils import humanbytes, time_formatter
...
CMD_HELP.update({
    ...
    "download the file into your wolfuserbot server."
})
