...
from wolfuserbot import (AFKREASON, COUNT_MSG, CMD_HELP, ISAFK, BOTLOG,
...
AFKSTR = [
    ...
    "`Sorry, I'm not here right now.\nFeel free to talk to my wolfuserbot as long as you like.\nI'll get back to you later.`",
...
async def set_afk(afk_e):
    ...
    if string:
        AFKREASON = string
        await afk_e.edit(f"🏃🏻‍♂️🏃🏻‍♂️ **Going AFK!**\
        \nReason: `{string}`")
    else:
        await afk_e.edit("🏃🏻‍♂️🏃🏻‍♂️ **Going AFK!**")
    if user.last_name:
