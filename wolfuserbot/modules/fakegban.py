...
from wolfuserbot import BOTLOG, BOTLOG_CHATID, CMD_HELP, bot, ALIVE_NAME
...
async def gbun(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 566137906:
            await reply_message.reply("`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 6969$ to my master__ [Rajveer](tg://user?id=732510605) __to release your account__😏")
        else:
            jnl=("`Warning!!`"
                  "[{}](tg://user?id={})"
