...
""" WolfUserBot module for having some fun with people. """
...
RUNS_STR = [
    ...
    "Running faster than Bolt coz i'mma wolfuserbot !!",
    "Runs to Marie..",
...
async def univsaye(cowmsg):
    """ For .cowsay module, wolfuserbot wrapper for cow which says things. """
...
async def react_meme(react):
    """ Make your wolfuserbot react to everything. """
...
\n\n`.react`\
\nUsage: Make your wolfuserbot react to everything.\
\n\n`.slap`\
