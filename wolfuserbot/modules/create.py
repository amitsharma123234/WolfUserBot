    ...
    if not grop.text[0].isalpha() and grop.text[0] not in ("/", "#", "@", "!"):
        ...
        if type_of_group == "b":
            try:
                ...
                await grop.edit("Your {} Group Created By Wolf User Bot Successfully. Click [{}]({}) to join".format(group_name, group_name, result.link))
            ...
            try:
                ...
                await grop.edit("Your {} Group/Channel Created By Wolf User Bot Successfully. Click [{}]({}) to join".format(group_name, group_name, result.link))
            except Exception as e:  # pylint:disable=C0103,W0703
                await grop.edit(str(e))
