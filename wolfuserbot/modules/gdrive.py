...
import wolfuserbot.modules.sql_helper.google_drive_sql as helper
...
from wolfuserbot.utils import progress, humanbytes, time_formatter, human_to_bytes
from wolfuserbot.utils.exceptions import CancelProcess
from wolfuserbot.modules.aria import aria2, check_metadata
# =========================================================== #
#                          STATIC                             #
# =========================================================== #
...
async def upload(gdrive, service, file_path, file_name, mimeType):
    ...
    body = {
        "name": file_name,
        "description": "Uploaded from Telegram using ProjectBish wolfuserbot.",
        "mimeType": mimeType,
    }
    try:
        if parent_Id is not None:
