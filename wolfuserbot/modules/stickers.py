...
#
""" WolfUserBot module for kanging stickers or making new ones. Thanks @rupansh"""
...
from wolfuserbot import bot, CMD_HELP
...
async def kang(event):
    ...
    packtitle = (f"@{user.username or user.first_name}'s Wolf Pack "
