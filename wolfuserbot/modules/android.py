...
#
""" WolfUserBot module containing commands related to android"""
...
from wolfuserbot import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
from wolfuserbot.events import register
from wolfuserbot.utils import chrome, humanbytes, time_formatter, md5, human_to_bytes
...
\nUsage: Download pixel experience ROM into your wolfuserbot server.\
\n\n`.spec <brand> <device>`\
